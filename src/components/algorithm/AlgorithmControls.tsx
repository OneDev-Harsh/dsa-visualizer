...
export default function AlgorithmControls({
  ...
  return (
    <div className="bg-[#141416] border border-[#1e1e22] rounded-xl p-3">
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-1.5">
          <button
            ...
            title="Restart (R)"
            className="p-2 rounded-lg text-[#6b6b76] hover:text-[#ececec] hover:bg-[#1a1a1e] transition-all focus-ring"
          >
          ...
          <button
            ...
            title="Previous (←)"
            className="p-1.5 rounded-lg text-[#6b6b76] hover:text-[#ececec] hover:bg-[#1a1a1e] transition-all disabled:opacity-30 disabled:cursor-not-allowed focus-ring"
          >
          ...
          <button
            ...
            className={`p-2.5 rounded-lg bg-[#3b82f6] text-white hover:bg-[#2563eb] transition-all focus-ring ${
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs text-[#6b6b76] font-mono tabular-nums whitespace-nowrap">
        ...
        <div className="relative" ref={speedRef}>
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-sm text-[#6b6b76] hover:text-[#ececec] hover:bg-[#1a1a1e] transition-all border border-[#1e1e22] focus-ring"
          >
      ...
      <div
        className="mt-3 h-1 bg-[#1e1e22] rounded-full overflow-hidden cursor-pointer"
        role="progressbar"
